...
class _NoticeDetailPageWidgetState extends State<NoticeDetailPageWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      future: NoticesGroup.findOneNoticeCall.call(
      ...
      builder: (context, snapshot) {
        ...
        final noticeDetailPageFindOneNoticeResponse = snapshot.data!;
          ...
          child: Scaffold(
            ...
            body: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  if (getJsonField(
                        noticeDetailPageFindOneNoticeResponse.jsonBody,
                        r'''$.image.url''',
                      ) !=
                      null)
                    Stack(
                            ...
                            image: DecorationImage(
                              ...
                              image: Image.network(
                                '${FFAppConstants.apiUrl}/public${getJsonField(
                                  noticeDetailPageFindOneNoticeResponse
                                      .jsonBody,
                                  r'''$.image.url''',
                                ).toString()}',
                              ).image,
